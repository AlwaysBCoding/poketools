...
import { SpeedTiersDisplay } from "../components/SpeedTiersDisplay";
...
import { MoveCoverageTable } from "../components/MoveCoverageTable";
...
export const TeamMatchupScreen = () => {
  ...
  const [activeAnalysisTable, setActiveAnalysisTable] = useState<string>("");
  ...
  return (
    <div className="screen team-matchup-screen">
      ...
      {activeAttackingTeam && activeDefendingTeam ? (
        <div className="analysis-section">
          <div className="analysis-select-section">
            <h4 className="analysis-title">Analysis</h4>
            <select value={activeAnalysisTable} onChange={(e) => { setActiveAnalysisTable(e.target.value) }}>
              <option value={""} disabled={true}>
                --Select Analysis--
              </option>
              <option value="speed-tiers">Speed Tiers</option>
              <option value="attacking-move-coverage">Attacking Move Coverage</option>
              <option value="defensive-move-coverage">Defensive Move Coverage</option>
            </select>
          </div>
